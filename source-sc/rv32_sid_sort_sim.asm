...
display:
      lw      x5, 0(x1)           # read switches from 0xffff0004
      andi    x5, x5, 0x100       # SW[8] selects sorted/original sid
      beq     x5, x0, show_original
      lw      x3, 0x184(x0)       # SW[8] = 1: show sorted sid
      jal     x0, write_display
show_original:
      lw      x3, 0x180(x0)       # SW[8] = 0: show original sid
write_display:
      sw      x3, 0(x2)           # write display data to 0xffff000c
end:  jal     x0, display         # dead loop for board display
############
...
# x1 = 0xffff0004
# x2 = 0xffff000c
# x5 = SW[8] masked value, either 0x00000000 or 0x00000100
